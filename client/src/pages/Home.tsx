...
const faqs = [
  ...
  ["Como funciona o pagamento?", "Você poderá realizar o pagamento pelas opções disponibilizadas no checkout. As formas de pagamento e condições de parcelamento serão apresentadas no momento da compra."],
];
