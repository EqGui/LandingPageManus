        ...
        <div className="container">
          ...
          <article className="offer-livret relative mx-auto mt-12 max-w-xl overflow-hidden border border-[#d8b76d]/55 bg-[#fffdf7] shadow-[0_28px_65px_rgba(0,0,0,.22)]">
            ...
            <div className="relative z-10 p-7 sm:p-9">
              ...
              <button onClick={() => openCheckout("offer_price")} data-analytics-event="checkout_start" className="btn-primary mt-6 w-full py-3 text-sm">Quero o Método CASAR+ <ArrowRight className="h-4 w-4" /></button>
