...
const authorsUrl = "/manus-storage/IMG-20260719-WA0032-1_3e3e7ccb.jpg";
...
const materials = [
  ...
  { label: "Material de apoio", title: "Guia de negociação", copy: "Tenha orientações práticas para se preparar melhor para conversas e negociações com fornecedores.", Icon: HandCoins, tone: "gold" },
  { label: "Material de apoio", title: "Checklists e calculadora", copy: "Organize as etapas do planejamento, reduza o risco de esquecer decisões importantes e estime como distribuir o orçamento antes de contratar.", Icon: Calculator, tone: "sage" },
];
...
const offerIncludes = [
  ...
  ["Guia de negociação e checklists", "Para se preparar melhor para conversas e não esquecer decisões importantes."],
  ["Calculadora de orçamento", "Para estimar como distribuir o orçamento antes de começar a contratar."],
];
        ...
        <div className="container grid min-h-[630px] items-center gap-10 py-12 lg:grid-cols-[1.05fr_.95fr] lg:py-16">
          <div className="relative z-10 py-3 lg:py-12">
            ...
            <div className="mt-8 flex">
              <a href={CHECKOUT_URL} data-analytics-event="cta_click" data-analytics-label="hero" className="btn-primary">Quero o Método CASAR+ <ArrowRight className="h-4 w-4" /></a>
            </div>
        ...
        <div className="container">
          ...
          <article className="offer-livret relative mx-auto mt-12 max-w-xl overflow-hidden border border-[#d8b76d]/55 bg-[#fffdf7] shadow-[0_28px_65px_rgba(0,0,0,.22)]">
            ...
            <div className="relative z-10 p-7 sm:p-9">
              ...
              <div className="mt-6 flex flex-wrap items-end gap-x-4 gap-y-2"><span className="text-sm font-bold text-[#808274]">De <span className="line-through">R$ 997,00</span></span><span className="rounded-full bg-[#e5d0a3] px-3 py-1 text-[0.61rem] font-extrabold tracking-wide text-[#675027] uppercase">R$ 497,00</span></div>
              <div className="mt-2 flex items-end gap-2 text-[#2c3625]"><span className="mb-2 text-xl font-bold">R$</span><span className="font-display text-7xl leading-none tracking-[-.05em]">497</span><span className="mb-2 text-xl font-bold">,00</span></div>
               <p className="text-sm font-bold leading-6 text-[#4d5a43]">Em até 10x de R$ 49,70 sem juros</p>
